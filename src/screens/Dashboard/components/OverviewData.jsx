...
const OverviewData = ({  props, IconClass }) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full flex max-lg:flex-col justify-between max-lg:justify-center items-center max-lg:items-start pl-[32px] pr-[76px] gap-y-[40px]">
        {/* Category Data */}
        {props?.map((item, index) => (
          ...
          >
            {/* Icon image */}
            <div className={twMerge(" w-fit p-[20px] rounded-full bg-[#B9FFC2] flex justify-center items-center", IconClass)}>
