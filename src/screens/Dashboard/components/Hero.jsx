...
const DashboardHero = ({ setShowAddLeads }) => {
  return (
    <div>
      <div className=" bg-[#F1F1F1] pb-[43px] max-lg:mt-[44px] ">
        <div className="flex px-[56px] pt-[24px] justify-center items-center">
          <img src={DashboardImage} className="" />
        </div>
        <div className="flex flex-col xsm:px-[24px] max-xsm:px-[8px] lg:px-[105px] font- max-lg:gap-y-[8px] mt-[64px] lg:mt-[24.99px] font-poppins">
