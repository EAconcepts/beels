...
const PersonalTasks = () => {
    ...
    return (
        <div className=' bg-white max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-start '>
            ...
            <p className='mx-5 md:hidden text-[#000000] text-[20px] max-lg:text-lg max-md:text-base max-sm:text-sm font-[600] font-[Inter] mt-7 '> In Progress Tasks </p>
            <div className='mx-5 w-[95%] px-2 mt-2 md:hidden '>
            ...
            <p className=' mx-5 md:hidden text-[#000000] text-[20px] max-lg:text-lg max-md:text-base max-sm:text-sm font-[600] font-[Inter] mt-7 '> To-do Tasks </p>
            <div className='mx-5 justify-between flex items-center md:hidden w-[95%]'>
