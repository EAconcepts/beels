...
const SubAmbassadorOverview = ({
  ...
  const formatDate = createdDate.toLocaleDateString(undefined, {
    year: "numeric",
    month: "long",
    day: "numeric",
  });
      ...
      <div className="w-[45%] max-lg:w-[98%]">
        <div className=" border border-[#E4E7EC] rounded-md pb-3">
          <div className="flex justify-between items-center px-5 py-2 border-b border-[#E4E7EC]">
            ...
            <div className="w-[50%]">
              <p className="text-[#667185] text-[12px] max-lg:text-[10px] max-sm:text-[8px] font-[400] font-[Inter] ">
                {" "}
                Beels Account Number{" "}
              </p>
              <p className="text-[#101928] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[500] font-[Inter] ">
                {" "}
                {accountNumber}{" "}
              </p>
            </div>
          ...
          <div className="flex justify-between items-center px-5 py-2 border-b border-[#E4E7EC]">
            ...
            <div className="w-[50%]">
              ...
              <p className="text-[#AD3307] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[500] font-[Inter] ">
                {" "}
                {refLink}{" "}
              </p>
            </div>
        ...
        <div className="flex justify-between items-center my-3  max-xsm:flex-wrap ">
          <div className="border border-[#E4E7EC] bg-[#FAF9F6] w-[30%] max-sm:w-[32%] max-xsm:w-[45%] mt-2 rounded-md px-3 max-lg:px-2 max-xsm:px-1 py-2">
            <p className="text-[#667185] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[500] font-[Inter] ">
              {" "}
              Transaction{" "}
            </p>
            <div className="flex justify-start gap-4 items-center flex-wrap">
              <p className="text-[#101928] text-[20px] max-lg:text-lg max-md:text-base max-sm:text-sm font-[600] font-[Inter] ">
                {" "}
                5,647{" "}
              </p>
              <div className="flex justify-center lg:gap-2 px-2  items-center bg-[#E7F6EC] rounded-md">
                <TiArrowUp />
                <p className="text-[#036B26] text-[12px] max-lg:text-[10px] max-sm:text-[8px] font-[500] font-[Inter] ">
                  {" "}
                  2%{" "}
                </p>
              </div>
      ...
      <div className="w-[50%] max-lg:w-[98%]">
        <div className="flex justify-between items-center mt-3 max-xsm:flex-wrap  ">
          <div className="border border-[#5572a5] bg-[#FAF9F6] w-[30%] max-lg:w-[32%] max-xsm:w-[45%] mt-2 rounded-md px-3 max-lg:px-2 max-xsm:px-1 py-2 flex flex-col gap-16">
            ...
            <div className="flex justify-start gap-4 items-center flex-wrap">
              <p className="text-[#101928] text-[20px] max-lg:text-base max-md:text-sm max-sm:text-xs  font-[600] font-[Inter] ">
                {" "}
                {user?.length}{" "}
              </p>
        ...
        <p className="text-[#000000] text-[22px] max-lg:text-lg max-md:text-base max-sm:text-sm font-[600] font-[Inter] mt-7 ">
          {" "}
          Tasks{" "}
        </p>
        <div className="px-2 mt-2 ">
          <div className="flex justify-between items-center ">
            <p className="text-[#000000] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[400] font-[Poppins]  ">
              {" "}
              Onboard 20 Users{" "}
            </p>
            <p className="text-[#000000] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[400] font-[Poppins]  ">
          ...
          <div className="h-5 rounded-lg bg-[#DADFDE] w-full mt-1"></div>
        </div>
        <div className="px-2 mt-2">
          <div className="flex justify-between items-center ">
            <p className="text-[#000000] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[400] font-[Poppins]  ">
              {" "}
              Users with Virtual Cards{" "}
            </p>
            <p className="text-[#000000] text-[14px] max-lg:text-xs max-sm:text-[10px] font-[400] font-[Poppins]  ">
              {" "}
              0/20
        ...
        <div className="flex justify-between items-center mt-10 px-2">
          <p className="text-[#000000] text-[16px] max-lg:text-sm max-md:text-xs max-sm:text-[10px] font-[400] font-[Poppins]  ">
            {" "}
            Leaderboard Position{" "}
          </p>
          <p className="text-[#3AB54A] max-lg:text-[#082C25]  text-[20px] max-lg:text-lg max-md:text-base max-sm:text-sm font-[700] font-[Poppins]  ">
            {" "}
            None{" "}
          </p>
        </div>
